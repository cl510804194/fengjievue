...
public enum NotificationTypeEnum {
	ALL("ALL", "所有会员", "loadAllUser"),
	VIP("VIP", "VIP会员", "loadVIPUser"),
	GOLD("GOLD", "黄金会员", "loadGoldUser"),
	DIAMOND("DIAMOND", "钻石会员", "loadDiamondUser"),
	PLATINUM("PLATINUM", "白金会员", "loadPlatinumUser"),
	GENERAL("GENERAL", "普通", "loadGeneralUser"),
	INVESTOR("INVESTOR", "投资人", "loadInvestorUser"),
	BROKER("BROKER", "经纪人", "loadBrokerUser"),
	LOANER("LOANER", "融资人", "loadLoanerUser"),
	APPOINT("APPOINT", "指定会员", null);
