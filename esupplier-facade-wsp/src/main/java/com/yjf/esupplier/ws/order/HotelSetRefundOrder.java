 ...
 *
 */
public class HotelSetRefundOrder extends ValidateOrderBase  {
	...
	@Override
	public void check() {
		Assert.hasText(refundTime, "退款时间" + "不能为空!");
		Assert.hasText(userGrades, "用户等级" + "不能为空!");
	};
    //========== getters and setters ==========
	...
	public String toString() {
		return "HotelSetRefundInfo{" +
				...
				",userGradeHis=" + userGradeHis+
				'}';
	}
	public String getUserGradeHis() {
		return userGradeHis;
	}
	public void setUserGradeHis(String userGradeHis) {
		this.userGradeHis = userGradeHis;
	}
