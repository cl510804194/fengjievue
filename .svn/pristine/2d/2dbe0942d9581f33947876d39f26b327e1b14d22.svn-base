 ...
 *
 */
public enum YrdDomainResultEnum {
	 ...
	 * @param message
	 */
	private YrdDomainResultEnum(String code, String message) {
		this.code = code;
	 ...
	 */
	public static YrdDomainResultEnum getByCode(String code) {
		for (YrdDomainResultEnum _enum : values()) {
	 ...
	 */
	public List<YrdDomainResultEnum> getAllEnum() {
		List<YrdDomainResultEnum> list = new ArrayList<YrdDomainResultEnum>();
		for (YrdDomainResultEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
