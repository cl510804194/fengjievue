 ...
 */
package com.yjf.esupplier.domain.enums;
 ...
 *
 */
public enum EsupplieDomainResultEnum {
	 ...
	 * @param message
	 */
	private EsupplieDomainResultEnum(String code, String message) {
		this.code = code;
	 ...
	 */
	public static EsupplieDomainResultEnum getByCode(String code) {
		for (EsupplieDomainResultEnum _enum : values()) {
	 ...
	 */
	public List<EsupplieDomainResultEnum> getAllEnum() {
		List<EsupplieDomainResultEnum> list = new ArrayList<EsupplieDomainResultEnum>();
		for (EsupplieDomainResultEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
